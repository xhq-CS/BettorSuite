...
export const getGetPlayerStatsUrl = (id: number,
    period: 'week' | 'biweek' | 'month' | 'season',) => {




  return `/api/players/${id}/stats/${period}`
}
...
export const getPlayerStats = async (id: number,
    period: 'week' | 'biweek' | 'month' | 'season', options?: RequestInit): Promise<PlayerGameStat[]> => {

  return customFetch<PlayerGameStat[]>(getGetPlayerStatsUrl(id,period),
  {
    ...options,
    method: 'GET'
...
export const getGetPlayerStatsQueryOptions = <TData = Awaited<ReturnType<typeof getPlayerStats>>, TError = ErrorType<unknown>>(id: number,
    period: 'week' | 'biweek' | 'month' | 'season', options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPlayerStats>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetPlayerStatsQueryKey(id,period);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getPlayerStats>>> = ({ signal }) => getPlayerStats(id,period, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined && period !== null && period !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPlayerStats>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetPlayerStats<TData = Awaited<ReturnType<typeof getPlayerStats>>, TError = ErrorType<unknown>>(
 id: number,
  ...
  const queryOptions = getGetPlayerStatsQueryOptions(id,period,options)
...
export const getGetPlayerPropSummaryUrl = (id: number,) => {




  return `/api/players/${id}/prop-summary`
}

/**
 * @summary Averaged prop stats for a player (useful for betting lines)
 */
export const getPlayerPropSummary = async (id: number, options?: RequestInit): Promise<PlayerPropSummary> => {

  return customFetch<PlayerPropSummary>(getGetPlayerPropSummaryUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getGetPlayerPropSummaryQueryKey = (id: number,) => {
    return [
    `/api/players/${id}/prop-summary`
    ] as const;
    }


export const getGetPlayerPropSummaryQueryOptions = <TData = Awaited<ReturnType<typeof getPlayerPropSummary>>, TError = ErrorType<unknown>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPlayerPropSummary>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetPlayerPropSummaryQueryKey(id);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getPlayerPropSummary>>> = ({ signal }) => getPlayerPropSummary(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPlayerPropSummary>>, TError, TData> & { queryKey: QueryKey }
}

export type GetPlayerPropSummaryQueryResult = NonNullable<Awaited<ReturnType<typeof getPlayerPropSummary>>>
export type GetPlayerPropSummaryQueryError = ErrorType<unknown>
...
export function useGetPlayerPropSummary<TData = Awaited<ReturnType<typeof getPlayerPropSummary>>, TError = ErrorType<unknown>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPlayerPropSummary>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetPlayerPropSummaryQueryOptions(id,options)
...
export const getGetTeamStatsUrl = (id: number,
  ...
  return `/api/teams/${id}/stats/${period}`
}
...
export const getTeamStats = async (id: number,
    period: 'week' | 'biweek' | 'month' | 'season', options?: RequestInit): Promise<TeamGameStat[]> => {

  return customFetch<TeamGameStat[]>(getGetTeamStatsUrl(id,period),
  {
    ...options,
    method: 'GET'
...
export const getGetTeamStatsQueryKey = (id: number,
    period: 'week' | 'biweek' | 'month' | 'season',) => {
    return [
    `/api/teams/${id}/stats/${period}`
    ] as const;
    }


export const getGetTeamStatsQueryOptions = <TData = Awaited<ReturnType<typeof getTeamStats>>, TError = ErrorType<unknown>>(id: number,
    period: 'week' | 'biweek' | 'month' | 'season', options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTeamStats>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetTeamStatsQueryKey(id,period);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getTeamStats>>> = ({ signal }) => getTeamStats(id,period, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined && period !== null && period !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTeamStats>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetTeamStats<TData = Awaited<ReturnType<typeof getTeamStats>>, TError = ErrorType<unknown>>(
 id: number,
  ...
  const queryOptions = getGetTeamStatsQueryOptions(id,period,options)
...
export const getGetTrendingPropsUrl = () => {
 ...
 */
export const getTrendingProps = async ( options?: RequestInit): Promise<TrendingProp[]> => {

  return customFetch<TrendingProp[]>(getGetTrendingPropsUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetTrendingPropsQueryKey = () => {
    return [
    `/api/stats/trending`
    ] as const;
    }
...
export const getGetTrendingPropsQueryOptions = <TData = Awaited<ReturnType<typeof getTrendingProps>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTrendingProps>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetTrendingPropsQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getTrendingProps>>> = ({ signal }) => getTrendingProps({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTrendingProps>>, TError, TData> & { queryKey: QueryKey }
}

export type GetTrendingPropsQueryResult = NonNullable<Awaited<ReturnType<typeof getTrendingProps>>>
export type GetTrendingPropsQueryError = ErrorType<unknown>
...
export function useGetTrendingProps<TData = Awaited<ReturnType<typeof getTrendingProps>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTrendingProps>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetTrendingPropsQueryOptions(options)
